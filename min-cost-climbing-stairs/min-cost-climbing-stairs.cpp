...
//--------------------------------------------------------------------------------------
ll bottom_up_opti(ll n, vi arr)
{
    ll cost= 0;
    ll cost1 = arr[1], cost2 = arr[0];
    for(auto i = 2; i < n; i++) {cost = min(cost1 + arr[i], cost2 + arr[i]); cost2 = cost1; cost1 = cost;}
    ...
    int minCostClimbingStairs(vector<int>& cost) {
        ...
        return (int) bottom_up_opti(cost.size(), cost);
    }
};